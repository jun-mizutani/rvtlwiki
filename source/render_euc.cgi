...
12170     ;=(L(0)=$a1)|(L(0)=$a2) #=^_jp_header              : 見出し
...
12450     #=^_endAnalyze
12460   ^_jp_header
12470     ;=(L(0)=$a1)&(L(1)=$fa) M='C' C=1 c=2 #=^_endAnalyze : EUC
12480     ;=(L(0)=$a2)&(L(1)=$a3) M='C' C=2 c=2 #=^_endAnalyze
12490     ;=(L(0)=$a1)&(L(1)=$fc) M='C' C=3 c=2 #=^_endAnalyze
12500     ;=(L(0)=$a2)&(L(1)=$a1) M='C' C=4 c=2 #=^_endAnalyze
12510     ;=(L(0)=$a2)&(L(1)=$a5) M='C' C=5 c=2 #=^_endAnalyze
12520     ;=(L(0)=$a1)&(L(1)=$f9) M='C' C=6 c=2 #=^_endAnalyze
12530     #=^_endAnalyze
12540   : 空白
12550   ^_space
