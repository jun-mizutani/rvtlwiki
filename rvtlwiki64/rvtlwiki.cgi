...
10050 : Copyright (C) 2005-2025: RvtlWiki (rvtlwiki.cgi)
...
29550   |vc
29560   k=%
29570   ;=(k=5) a=36 b=x c=-100 d=y  : symlinkat (Arm64)
29580   ;=(k=4) a=88 b=x c=y : symlink (x86_64)
29590   |zz
29600   r=|
29610   -cba
29620 ]
...
29700   |vc
29710   k=%
29720   ;=(k=5) a=35 b=-100 c=x d=0 : unlinkat (Arm64)
29730   ;=(k=4) a=87 b=x        : unlink (x86_64)
29740   |zz
29750   r=|
29760   -kdcba
29770 ]
...
29940 :-------------------------------------------------
29950 : lock & wait
29960 : x() : filename to be locked
29970 : r=0 : success, r=-1 : failure
29980 :-------------------------------------------------
29990 ^LockWait
30000   +ie
30010   i=0
...
30150 :-------------------------------------------------
30160 : unlock
30170 : x() : filename to be unlocked
30180 :-------------------------------------------------
30190 ^Unlock
30200   +cyz
30210   c=z z=z+256
...
30410   |vc
30420   k=%
30430   ;=(k=5) a=63      : read (Arm64)
30440   ;=(k=4) a=0       : read (x86_64)
30450   b=0               : stdin
30460   @
30470     c=x             : buffer
30480     |zz
...
30550 :
30560 :-----------------------------------------
30570 : 時間を測定するプログラムにマージして実行
30580 :   !=^TimerStart から !=^TimerStop の時間
30590 :   #=-1 の前に !=^TimerStop を置く事
30600 :   変数スタックに値を積むためすべての変数
30610 :   は影響を受けない。
30620 :-----------------------------------------
30630 :----------------------------------
30640 : 時間計測開始
...
30740     -ut x=_ y=%
30750     d=x-t f=y-u
30760     ;=(f<0) d=d-1 f=f+1000000
30770     "  time:" ?=d "." ?[6]=f "sec" /
30780 ]
30790
#=1
~
