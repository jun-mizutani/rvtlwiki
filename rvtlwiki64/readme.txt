...
必要です。rvtl64-4.01.tar.gz (PC 64bit)、rvtl64arm-4.01.tar.gz (Arm64)
中の rvtl64 を /usr/bin/ にコピーしてください。
...
- (1) 必要ならrvtlwiki.cgiのはじめの方にある、U['W']、U['H']などの値を修正して下さい。
...
- (3)ファイル一覧にあるファイルをサーバに転送します。転送モードやパーミッション
    を環境にあわせ適切に設定して下さい。
